...
T_Treatments_Counts <- T_Treatments_Counts %>% dplyr::select(c("T_PCD11_LMoDC_1", "T_PCD11_LMoDC_2", "T_PCD11_LMoDC_3", "T_PCD11_LMoDC_4"))
...
cell_pairs <- c("MoDC_6H","T_PCD11_LMoDC")
for(cell_pairs in c(c("MoDC_6H","T_PCD11_LMoDC"))){ #Samples' names
  #conflicted::conflict_prefer("select","stats","dplyr")
  ...
  createCircosPlot(LR = LR,
                   ...
                   Figure_name = paste0("C:\\Kfir_Thesis_Asaf_Madi\\Project_2 - BulkRNAseq\\Circos_Code\\",cell_pairs[1],"_",cell_pairs[2],"_Circos.pdf"), title = "Ligand-Receptor Interactions", subtitle = "MoDC6H unique up regulated Ligands VS PcDC_LMoDC up regulated Receptors")
